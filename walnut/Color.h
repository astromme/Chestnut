...
struct Color : uchar4 {
  ...
  __host__ __device__ bool operator==(const Color &rhs) { return (x == rhs.x && y == rhs.y && z == rhs.z && w == rhs.w); }
  __host__ __device__ bool operator!=(const Color &rhs) { return !(*this == rhs); }
