             ...
             int whichKernel, T *d_idata, T *d_odata)
{
    ...
    {
    case 0:
        FUNC(reduce0)<T><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata);
        break;
    case 1:
        FUNC(reduce1)<T><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata);
        break;
    case 2:
        FUNC(reduce2)<T><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata);
        break;
    case 3:
        FUNC(reduce3)<T><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata);
        break;
    case 4:
        switch (threads)
        {
        ...
        case 256:
            FUNC(reduce4)<T, 256><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata); break;
        case 128:
            FUNC(reduce4)<T, 128><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata); break;
        case 64:
            FUNC(reduce4)<T,  64><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata); break;
        case 32:
            FUNC(reduce4)<T,  32><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata); break;
        case 16:
            FUNC(reduce4)<T,  16><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata); break;
        case  8:
            FUNC(reduce4)<T,   8><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata); break;
        case  4:
            FUNC(reduce4)<T,   4><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata); break;
        case  2:
            FUNC(reduce4)<T,   2><<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata); break;
        case  1:
